...
What we do know, however, is <em>why</em> they’re used.
...
To combat squirt, many players use low-deflection cues, which have low end mass and so exert less lateral force on the cue ball. Most (but not all) low-deflection cues are made with a pro taper. A pro taper shaft typically has less end mass than a European taper shaft because it has less material near the tip (provided they’re made from the same materials).

A pro taper shaft also tends to be more flexible, which allows it to slightly bend away from the cue ball immediately after the stroke instead of staying in contact, further reducing squirt.

## Bridge Hand Dynamics
