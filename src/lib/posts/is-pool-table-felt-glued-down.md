---
title: Is Pool Table Felt Glued Down?
date: "2023-08-28"
...
<strong>The answer is yes, pool table felt is often glued down. But that’s not the only way to secure the felt to the table. Staples are sometimes used instead of glue. But pool table glue is not the kind you’re likely to have around the house. The best pool table glue is designed to work on pool table felt.</strong>
...
<li>The table cloth needs to be stretched tight during installation. Gluing only the edges allows the installer to properly stretch the cloth tight over the playing surface.</li> <li>Second, the cloth doesn’t actually need to be glued down on the playing surface itself. Doing so would only make changing the cloth in the future more difficult.</li>
