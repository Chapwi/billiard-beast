...
<strong>Obviously, pool tables are heavy. But assuming your home was built to code and that the weight of the pool table doesn’t exceed the weight limit of your second floor, you can safely place a pool table upstairs. So unless you live in a really old home, the only problem you’ll have with putting a pool table on the second floor is getting it there.</strong>
