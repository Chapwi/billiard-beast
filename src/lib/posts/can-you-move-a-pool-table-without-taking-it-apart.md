---
title: Can You Move a Pool Table Without Taking it Apart?
date: "2023-08-17"
...
<em>You can move a pool table without taking it apart, but there are many factors to consider, like how far you’re moving it and the type of table it is. To avoid injury, damage to the table, and a massive headache, most tables should be taken apart to be moved.</em>
...
<li><strong>You could damage the table:</strong> The biggest risk, no matter the type of table, is that you’ll damage it in the move. It can be easy to get stuck in a doorway or on some stairs with an assembled pool table. Trying to get it unstuck is when things generally go wrong.</li> <li><strong>You could break the slate:</strong> If you have a slate table, it’s surprisingly easy to break or crack the slate if you don’t know what you’re doing.</li> <li><strong>You could injure yourself or others:</strong> Pool tables— especially slate tables— are very heavy. Trying to move it with an inadequate number of people can result in injury. Even if you do have enough people, injury is a risk you have to consider.</li> <li><strong>You could damage the frame:</strong> Trying to move a slate table can result in a damaged frame. The slate is so heavy that it needs to be supported by the legs. So, when you lift the table off the ground, the frame takes all that weight, which can cause damage.</li>

Moving a pool table a short distance can be done without taking it apart. In fact, disassembling the table just to move it to another room or out of the way isn’t usually a good idea. <strong><em>It depends on whether you can fit it through doorways easily while it’s fully assembled. If you have to go up or down stairs, you’ll probably want to disassemble the table to reduce the risk of damage and injury.</em></strong>
...
<li><strong>A 7-foot slate table weighs around 700 to 750 pounds.</strong></li> <li><strong>An 8-foot slate table weighs around 850 to 900 pounds.</strong></li> <li><strong>A 9-foot slate table weighs around 900 to 1000 pounds.</strong></li>

The slate alone weighs around 450 to 500 pounds.
