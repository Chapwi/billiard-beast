...
<strong>For best results, pool tables do need to be climate controlled. A pool table in a climate-controlled area will last longer and play better than a table left to the elements. Luckily, it’s fairly easy to add climate control to an unfinished basement or a garage so you can play your heart out.</strong>
...
<strong><em>Now, the rest of this article will concern slate pool tables unless otherwise mentioned.</em></strong>
