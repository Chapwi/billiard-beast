...
image: "/images/1-piece-slate_.webp"
---
...
Slate costs more because mining, cutting, and leveling 450-lb stone slabs requires specialized labor. MDF is factory-pressed wood fiber that costs a fraction to produce.
...
<strong>A slate bed pool table, or slate table for short, is simply a pool table that uses slate for its playing surface. A wood bed table is one that uses MDF (medium-density fiberboard) for its playing surface. Slate is more expensive and is used on high quality tables while MDF is used as a more budget friendly option.</strong>
